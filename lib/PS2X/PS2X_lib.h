...
class PS2X {
  public:
    ...
    byte readType();
    byte config_gamepad(uint8_t clk, uint8_t att, uint8_t cmd, uint8_t dat);
    byte config_gamepad(uint8_t clk, uint8_t att, uint8_t cmd, uint8_t dat, bool pressures, bool rumble);
    void enableRumble();
