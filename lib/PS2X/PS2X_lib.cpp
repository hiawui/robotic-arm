...
/****************************************************************************************/
byte PS2X::config_gamepad(uint8_t clk, uint8_t att, uint8_t cmd, uint8_t dat) {
   return config_gamepad(clk, att, cmd, dat, false, false);
}

/****************************************************************************************/
byte PS2X::config_gamepad(uint8_t clk, uint8_t att, uint8_t cmd, uint8_t dat, bool pressures, bool rumble) {
